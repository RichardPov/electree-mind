...
const NAV_USER_CORE = [
  ...
  { href: "/dashboard/certifikace", label: "Testy", icon: (<svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4" /><path d="M6 20v-2a4 4 0 014-4h4a4 4 0 014 4v2" strokeLinecap="round" /><path d="M9 21l3-3 3 3" strokeLinecap="round" strokeLinejoin="round" /></svg>) },
  ...
  { href: "/dashboard/videa", label: "Videa", icon: (<svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><polygon points="23 7 16 12 23 17 23 7" /><rect x="1" y="5" width="15" height="14" rx="2" /></svg>) },
...
const SEARCH_INDEX = [
  ...
  { label: "Produktový specialista – test", category: "Testy", href: "/dashboard/certifikace" },
